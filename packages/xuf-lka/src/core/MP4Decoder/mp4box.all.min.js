...
export default {createFile:MP4Box.createFile,ISOFile:ISOFile,DataStream:DataStream,Log:Log,MP4BoxStream:MP4BoxStream};
export {ISOFile,DataStream,Log,MP4BoxStream};
