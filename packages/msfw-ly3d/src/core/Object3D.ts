...
const _childaddedEvent = {child: null as Object3D | null}
const _childremovedEvent = {child: null as Object3D | null}
...
class Object3D<TEventMap extends Object3DEventMap = Object3DEventMap> extends EventDispatcher<TEventMap> {
  ...
  add(object: Object3D, ...args: Object3D[]) {
    ...
    this.dispatchEvent('childadded' as any, _childaddedEvent)
